...
static ngx_int_t ngx_http_request_body_save_filter_upload(ngx_http_request_t *r, ngx_chain_t *in);
...
static ngx_int_t
ngx_http_request_body_save_filter_upload(ngx_http_request_t *r, ngx_chain_t *in)
{
#if (NGX_DEBUG)
    ngx_chain_t               *cl;
#endif
...
ngx_http_request_body_length_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    rc = ngx_http_request_body_save_filter_upload(r, out);
